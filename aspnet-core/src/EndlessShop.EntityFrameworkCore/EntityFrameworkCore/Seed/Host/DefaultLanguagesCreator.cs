...
namespace EndlessShop.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly EndlessShopDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = EndlessShopConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(EndlessShopDbContext context)
        {
            _context = context;
        }
