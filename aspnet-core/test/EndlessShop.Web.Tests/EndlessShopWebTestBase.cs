...
{
    public abstract class EndlessShopWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EndlessShopWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EndlessShopWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EndlessShopDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EndlessShopDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EndlessShopDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EndlessShopDbContext, Task<T>> func)
        {
            T result;
